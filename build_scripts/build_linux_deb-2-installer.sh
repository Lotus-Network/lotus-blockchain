...
export LOTUS_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="lotus-blockchain-cli_$LOTUS_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/lotus"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/lotus/"
ln -s ../../opt/lotus/lotus "dist/$CLI_DEB_BASE/usr/bin/lotus"
dpkg-deb --build --root-owner-group "dist/$CLI_DEB_BASE"
# CLI only .deb done

cp -r dist/daemon ../lotus-blockchain-gui/packages/gui
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="lotus-blockchain"
...
GUI_DEB_NAME=lotus-blockchain_${LOTUS_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${LOTUS_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
