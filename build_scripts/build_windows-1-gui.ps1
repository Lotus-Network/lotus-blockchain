...
Write-Output "Remove unused @lotus packages to make cache slim"
...
# Remove `packages/gui/node_modules/@lotus` because it causes an error on later `electron-packager` command
Remove-Item "@lotus" -Recurse -Force
