...
from lotus.protocols.harvester_protocol import PlotSyncError, PlotSyncResponse
...
from lotus.util.ints import int16, uint64
...
async def skip_processing(self: Any, _: WSLotusConnection, message_type: ProtocolMessageTypes, message: Any) -> bool:
...
async def _testable_process(
    self: Any, peer: WSLotusConnection, message_type: ProtocolMessageTypes, message: Any
) -> None:
