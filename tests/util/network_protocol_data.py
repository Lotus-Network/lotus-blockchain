...
from lotus.types.weight_proof import WeightProof, SubEpochData, SubEpochChallengeSegment, SubSlotData, RecentChainData
...
from lotus.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, FoliageBlockData, TransactionsInfo

from lotus.protocols import (
    farmer_protocol,
    full_node_protocol,
    harvester_protocol,
    introducer_protocol,
...
timestamped_peer_info = TimestampedPeerInfo("127.0.0.1", uint16(5980), uint64(10796))
