...
from lotus.data_layer.data_layer_util import NodeType, Side, Status
...
class LotusRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["LOTUS_ROOT"] = os.fspath(self.path)
        kwargs["env"]["LOTUS_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("lotus"),
            "--root-path",
            self.path,
            *args,
        ]
