...
{
    Write-Output "Lotus requires a 64-bit Windows installation"
    Exit 1
}
...
venv\scripts\pip install --extra-index-url https://pypi.lotus.net/simple/ miniupnpc==2.2.2
venv\scripts\pip install --editable ".$extras_cli" --extra-index-url https://pypi.lotus.net/simple/
...
Write-Output "https://keybase.io/team/lotus_network.public"
Write-Output ""
